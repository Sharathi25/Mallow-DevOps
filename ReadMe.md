...
7. Share a GitHub repository to Github account “Mallowdev” and send an email to the HR team (hr@mallow-tech.com) about the completion along with Github repository link and branch details.
